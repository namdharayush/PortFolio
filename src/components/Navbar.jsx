                ...
                <div className=''>
                    <div className="row">
                        ...
                        <div className="col-2 third" >
                            <NavLink download={Ayush_Resume} style={{ textDecoration: 'none' }} to={Ayush_Resume}><button className='btn'>Resume<MdDownloading className='download_icon' /></button></NavLink>
                        </div>
                    </div>
                </div>
            </div>
